...
> Tip: Outputs are written to original subfolders such as `Evoked_responses/`, `ICA/`, and `Thesis/Figures/`.  
> If you prefer, you can define a single base output directory and route all outputs under it.
